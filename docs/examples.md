...
### **1. Cellular Knowledge Graph**
#### Overview
The **Cellular Knowledge Graph (CL_KG)** is an ontology-driven application that integrates multiple biological ontologies to enable detailed exploration of cellular data. The project integrates the following ontologies:
- **Cell Ontology (CL)**
...
### **2. Cell Type Knowledge Explorer**
#### Overview
The **Cell Type Knowledge Explorer** is a private-sourced application powered by OBASK that serves as the backbone of the explorer tool available at:  
...
1. Define your input ontologies and configuration parameters in a YAML file.
2. Run OBASK to process and integrate your data.
3. Experiment with the generated Neo4j and search endpoints.

Start your journey today with [OBASK](quick_start.md) and unlock the power of your ontologies!
